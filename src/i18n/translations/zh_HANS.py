...
translations = (
    ...
    ("Start AI Rendering", "开始AI渲染", None),
    ...
    ("The activity camera will be used for output, please select the output mode.", "活动相机将被用于输出，请选择输出模式。", None),
    ("CameraRender equal to Composition Result.", "相机渲染=合并结果", None),
    ("CameraDepth equal to Mist (Mist effect can be set in World > Mist Pass).", "相机深度=雾场（雾场效果可在世界环境>雾场通道设置）", None),
    ("Prompt Optimization", "提示词优化", None),
    ("Enable Prompt Optimization to improve the quality of the generated image and the safety of the content.", "启用提示词优化，可提升描述准确性，以及生成内容的安全性", None),
    ("Image Size Config", "图像比例", None),
    ("Set the image size for the generated image.", "设置生成图像的长宽比，以满足生成需求", None),
    ("Image Resolution", "图像分辨率", None),
    ("Set the image resolution via both image size and aspect ratio, and the larger the resolution, the longer the generation time/resource required.", "结合图像比例，设置分辨率，分辨率越大需要更多的生成时间/资源", None),
    ("Service", "服务", None),
    ("The service is provided by the API provider. Please ensure network connectivity.", "服务由API方提供，注意网络畅通", None),
    ("The proceeds will be 100% allocated to support open-source development.", "收益将 100% 用于支持开源开发", None),
    ("Redeem for ice pops", "兑换冰糕", None),
    ("Buy ice pops", "获取冰糕", None),
    ("Edit", "编辑", None),
    ("Edit Image", "编辑图像", None),
    ("Open image editor and edit current image.", "打开图像编辑器，编辑当前图像。（可执行重绘、融图等编辑操作）", None),
    ("More", "详情", None),
    ("Details", "图像详情", None),
    ("View generated image details like prompt, generation time, etc.", "查看图像生成信息，例如提示词、生成时间等内容", None),
    ("Generated by %s", "%s 生成", None),
    ("List", "队列", None),
    ("Output Directory", "缓存目录", None),
    ("History", "历史", None),
    ...
    ("Redeem Code Error or Already Used, Please Check or Contact Customer Service", "兑换码错误或已被使用，请检查或联系客服", None),
    ("Redeem Success!", "兑换成功！", None),
    ("Exit", "退出", None),
    ("You have obtained %s ice pops(credits)", "您已获得%s冰糕(积分)，注意刷新", None),
    ("Use this mode to support tool development", "使用此模式服务，可支援工具开发", None),
    ("Disclaimers", "免责声明", None),
    ("Feedback", "反馈问题", None),
    ("Community", "交流群", None),
    ("Account Mode (Recommended)", "账号模式(推荐)", None),
