...
translations = (
    ...
    ("Best Speed: faster provider first.", "最佳速度: 优先匹配报价最低服务商", None),
    ("Best Balance: more stable provider first.", "最佳稳定: 优先匹配生成稳定服务商", None),
    ("Best Speed", "最佳速度", PROP_TCTX),
    ("Best Speed", "最佳速度", None),
    ("Best Balance", "最佳稳定", PROP_TCTX),
    ("Best Balance", "最佳稳定", None),
