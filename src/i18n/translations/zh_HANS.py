...
error_translations = (
    ...
    ("Rate limit exceeded,Please check your API key and Google AI Studio account", "超过速率限制,请检查您的Api key及请Google AI Studio 账户", None),
...
studio_panel_translations = (
    ...
    ("More", "详情", None),
    ("Details", "图像详情", None),
    ("View generated image details like prompt, generation time, etc.", "查看图像生成信息，例如提示词、生成时间等内容",
     None),
